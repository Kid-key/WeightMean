...
class MobileNetV2(nn.Module):
    def __init__(self, n_class=1000, input_size=224, width_mult=1.,cbn=False):
        ...
        # building classifier
        self.classifier = nn.Linear(self.last_channel, n_class, bias=False)
        self.cbn = cbn
        if self.cbn:
...
def mobilenet_v2(cbn=False):
    model = MobileNetV2(width_mult=1,cbn=cbn)
