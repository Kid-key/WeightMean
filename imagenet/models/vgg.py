...
class VGG(nn.Module):
    ...
    def __init__(self, features,class_bn=False, num_classes=1000, init_v=2.0):
        ...
        for m in self.modules():
            if isinstance(m, nn.Conv2d):
                ...
                m.weight.data.normal_(0, math.sqrt(init_v / n))
...
def vgg16_nobn(init_v=2.8):
    model = VGG(make_layers(cfg['D']), False,init_v=init_v)
    return model
